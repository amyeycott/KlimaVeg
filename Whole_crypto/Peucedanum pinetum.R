...
PP_three_nmds_ss<-plot_grid(plot.lich, plot.bryo, plot.vasc, ncol = 3, nrow = 1)#does not plot visibly. This had to be used because facets overrides mfrow and it gets confused.
