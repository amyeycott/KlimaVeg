source("Bryophytes data loading")
...
#composition of living ashes across two years
library(vegan)
str(on.ls.ash)
...
speciesscores.ash.dca[(speciesscores.ash.dca$DCA1)>1,]
...
#is 2015 CWD more like the gorund or like 1992 FE_LS or like 2015 Fe_LS?
...
#winners, those who increased from fewer than 5 oplots in 1992 to more than 5 plots in 2015
