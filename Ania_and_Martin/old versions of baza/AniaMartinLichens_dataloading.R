...
hastrent<-as.vector(envir$Species[envir$Trentepohlia_photobiont==1])
############
...
comp<-as.data.frame(merge(t(comp_old), t(comp_trimnew), by=0, all=TRUE))
...
table(names(genus_comp[,colSums(genus_comp[genus_comp$Year==1992,])>0])%in%names(genus_comp[,colSums(genus_comp[genus_comp$Year==2015,])>0]))
table(names(genus_comp[,colSums(genus_comp[genus_comp$Year==2015,])>0])%in%names(genus_comp[,colSums(genus_comp[genus_comp$Year==1992,])>0]))
